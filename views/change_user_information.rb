  ...
  def form
     super.merge!({
      ...
      form_fields: [
        ...
        {field: "State", value: param_tag("State"), field_title: "Primary Address State", required: true, select: true, options_group: '<#OPTION name="custom" groupname="State" selectedValue="<#PARAM name=State>">'},
        ...
        {field: "SState", value: param_tag("SState"), field_title: "Secondary Address State", select: true, options_group: '<#OPTION name="custom" groupname="State" selectedValue="<#PARAM name=SState>">'},
