...
class ChangeUserInformation < Form
  ...
  def form
     super.merge!({
      ...
      form_fields: [
        {field: "EMailAddress", value: param_tag("EMailAddress"), field_title: "E-mail Address", input_text: true, required: true, readonly: true },
        ...
        {field: "State", value: param_tag("State"), field_title: "Primary Address State", required: true, select: true, options_group: '<#OPTION name="custom" groupname="State" selectedValue="<#PARAM name=State>" defaultValue="NONE" defaultName="">'},
        ...
        {field: "SState", value: param_tag("SState"), field_title: "Secondary Address State", select: true, options_group: '<#OPTION name="custom" groupname="State" selectedValue="<#PARAM name=SState>" defaultValue="NONE" defaultName="">'},
