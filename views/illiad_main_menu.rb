  ...
  def text_sections
    [
    {
      ...
      :paragraphs => [
        ...
        "<p>Want more information? Visit <a href=\"https://library.nyu.edu/services/ill.html\" target=\"_blank\">https://library.nyu.edu/services/ill.html</a> for details about who can use ILL, how long it takes, how to pick up materials, etc.</p>"
      ]
    }
    ]
  end
